...
jQuery(function ($) {
  ...
  $("#loader").slideUp(); // $(document).on( 'pjax:send', function() {
  //     $('#loader').slideDown()
  // } );
...
__webpack_require__(/*! ./bootstrap */ "./resources/js/bootstrap.js"); // require( './../../node_modules/jquery-pjax/jquery.pjax.js' );


__webpack_require__(/*! ./apex.js */ "./resources/js/apex.js");
